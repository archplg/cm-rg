...
The axes are interpretable. The horizontal axis (PC1) is dominated by **Root cause: psychological safety loss post-layoff** on one end and **Layoff-triggered psychological safety collapse** on the other - this is the single biggest dimension along which the options differ. The vertical axis (PC2) is dominated by **Root cause: psychological safety loss post-layoff** vs **E3, E5 — structural scaling and leadership mismatc**.
...
- **M1**: or having direct conversations; — the latter is the classic vocabulary of a team that no longer feels safe taking direct risks or having direct conversations; trust, fairness, and "am I next
- **M2**: missing the structural cause

## Operator action items

1. Option C was recommended only by M4 (neutral). What does this agent see that others missed - or what is it weighing differently?
...
result = AuditResult.load("operator_outputs/B_N_run5/operator_insight.json")
