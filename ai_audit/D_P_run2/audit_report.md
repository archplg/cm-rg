...
- **M2**: spending the bulk of the national budget defending yesterday’s geography
- **M3**: calculated as the product of *Hazard*, *Vulnerability*, and *Exposure*; zones to zero, ensuring maximum statistical durability of capital
- **M5**: zones over 15 years at roughly $17

## Operator action items

1. Option D was recommended only by M2 (C). What does this agent see that others missed - or what is it weighing differently?
2. The contrarian agent recommended D against the majority. Contrarian disagreement is a useful signal: what is the strongest argument against the majority choice that hasn't been answered?
...
result = AuditResult.load("operator_outputs/D_P_run2/operator_insight.json")
