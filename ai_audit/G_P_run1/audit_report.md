...
- **M5**: to acceptable bounds [95% CI: 2-5% chance of successful challenge based on historical data]

## Operator action items

1. All options scored near the middle on the axis 'Utilitarian life-saving optimization' vs 'Fairness through random allocation'. Does any option deserve a strong position here? If not, is this a dimension being underweighted?
...
result = AuditResult.load("operator_outputs/G_P_run1/operator_insight.json")
