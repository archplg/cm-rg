...
The axes are interpretable. The horizontal axis (PC1) is dominated by **Justifies Mastery via buyer profile and price-poin** on one end and **Positioned as a rigorous tool for technical skill ** on the other - this is the single biggest dimension along which the options differ. The vertical axis (PC2) is dominated by **Justifies Mastery via buyer profile and price-poin** vs **Price-justified niche economics and commercial int**.
...
- **M2**: attracting aspirational buyers who like the idea of making things more than the discipline of actually learning
- **M3**: becoming a fad; if you start at the pinnacle of expert craft, you earn the permission to introduce cheaper, more accessible products later on from a position of absolute authority
- **M4**: aspirational abandonment
...
result = AuditResult.load("operator_outputs/F_N_run2/operator_insight.json")
