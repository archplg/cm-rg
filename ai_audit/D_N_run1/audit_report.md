...
The axes are interpretable. The horizontal axis (PC1) is dominated by **Nature-based ecosystem adaptation** on one end and **Ecosystem-based coastal adaptation** on the other - this is the single biggest dimension along which the options differ. The vertical axis (PC2) is dominated by **Managed retreat and relocation** vs **Accept coastline loss, relocate populations inland**.
...
- **M1**: 10% of coastline, accept the higher cost there, and communicate ecosystem investments as a 15-year compounding shield, not immediate protection
- **M2**: map rather than repeatedly defending the existing one; zones, stop subsidizing new exposure, compensate households fairly, preserve cultural sites where possible, and build receiving communities with housing, transport, schools, health services, and jobs; creating a false sense of security and locking scarce public funds into places that may become increasingly expensive or impossible to defend
- **M3**: threatening our $1T economy
- **M4**: development, concentrates populations in ever-more-vulnerable zones, and demands escalating maintenance costs as conditions worsen

## Operator action items

1. Option D was recommended only by M3 (neutral). What does this agent see that others missed - or what is it weighing differently?
2. Option A was recommended only by M4 (neutral). What does this agent see that others missed - or what is it weighing differently?
...
result = AuditResult.load("operator_outputs/D_N_run1/operator_insight.json")
