...
- **M2**: attracting people who like the idea of woodworking more than woodworking itself
...
result = AuditResult.load("operator_outputs/F_N_run3/operator_insight.json")
