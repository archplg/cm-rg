...
- **M4**: everyone is wrong to anchor on the layoff? The real signal is in the retro theme shift—from energised shipping to “process and communication
...
result = AuditResult.load("operator_outputs/B_P_run3/operator_insight.json")
