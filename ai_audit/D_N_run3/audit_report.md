...
The axes are interpretable. The horizontal axis (PC1) is dominated by **Coastal ecosystem defense** on one end and **E4, E5 — distributed, low-cost defense across full** on the other - this is the single biggest dimension along which the options differ. The vertical axis (PC2) is dominated by **E2 — physically relocate populations away from ris** vs **Focus on mitigating physical and geographic risks**.
...
- **M1**: as the 30–50 cm SLR projection drifts upward; in single points of failure, and exhausts the budget defending assets that 2–3M internal migrants will leave behind anyway
- **M2**: structurally rather than repeatedly rebuild after disasters; concentrating money in high-value urban areas while leaving smaller communities exposed; maps, voluntary buyouts first, full replacement-value compensation, protection of cultural sites where feasible, and major investment in receiving communities
- **M3**: from the digital domain
...
2. Option E was recommended only by M4 (neutral). What does this agent see that others missed - or what is it weighing differently?
...
result = AuditResult.load("operator_outputs/D_N_run3/operator_insight.json")
