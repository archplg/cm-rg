...
| **Option C** | 2 of 5 | M1/neutral, M5/neutral |
...
- **neutral frame (M1):** 10% of coastline, accept the higher cost there, and communicate ecosystem investments as a 15-year compounding shield, not immediate protection
- **neutral frame (M2):** map rather than repeatedly defending the existing one; zones, stop subsidizing new exposure, compensate households fairly, preserve cultural sites where possible, and build receiving communities with housing, transport, schools, health services, and jobs
- **neutral frame (M3):** threatening our $1T economy
- **neutral frame (M4):** development, concentrates populations in ever-more-vulnerable zones, and demands escalating maintenance costs as conditions worsen
