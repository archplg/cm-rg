...
- **H frame (M1):** the same error as A and D: treating the physical system as the patient when the patient is the society
- **C frame (M2):** spending the next 15 years defending yesterday’s settlement pattern
