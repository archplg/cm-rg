...
- **S frame (M2):** splitting attention, starving the core, and creating internal competition for scarce technical and go-to-market bandwidth; not failing to experiment
- **H frame (M4):** inflicting this harm through displacement or hollowing-out
...
**Q1.** Option A was recommended only by M4 (H). What does this agent see that others missed - or what is it weighing differently?

**Q2.** The contrarian agent recommended C against the majority. Contrarian disagreement is a useful signal: what is the strongest argument against the majority choice that hasn't been answered?
