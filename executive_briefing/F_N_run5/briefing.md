...
- **neutral frame (M1):** — niche TAM of ~200K — is a feature at this stage
- **neutral frame (M2):** making the product aspirational rather than used
- **neutral frame (M3):** becoming a passing fad; if you start with Mastery, you build an enduring category king
