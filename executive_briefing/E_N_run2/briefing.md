...
- **neutral frame (M1):** more directly
- **neutral frame (M2):** where post-hoc remedies are inadequate; uses, but it is not sufficient as the primary frontier framework
