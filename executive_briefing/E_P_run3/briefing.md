...
- **Q frame (M2):** concentrated in a small number of high-cost training runs, run by a small number of labs and cloud providers, making pre-deployment oversight feasible within 18 months; low-probability, they are high-consequence and potentially irreversible once powerful model weights proliferate
- **E frame (M4):** manifest discontinuously
