...
- **E frame (M1):** on the critical path of a launch
- **C frame (M3):** storing biological data in the cloud; everyone is wrong about the necessity of cloud-scale AI? The universal assumption is that users need a massive parameter model to receive effective health coaching
- **Q frame (M4):** to near zero, while still allowing collection of training data from consenting users (expected opt-in rate of 15–30% based on typical frictionless UX pilots)
...
**Q1.** Option A was recommended only by M3 (C). What does this agent see that others missed - or what is it weighing differently?

**Q2.** Option D was recommended only by M4 (Q). What does this agent see that others missed - or what is it weighing differently?
