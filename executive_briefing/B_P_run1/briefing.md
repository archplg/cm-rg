...
- **S frame (M1):** a leadership change that *re-triggers* the same safety wound the layoff opened
...
**Q1.** Option C was recommended only by M1 (S). What does this agent see that others missed - or what is it weighing differently?
