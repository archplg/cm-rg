...
- **H frame (M1):** above that) will eventually overwhelm; onto the vulnerable
- **C frame (M2):** coastal and low-lying zones; becoming an expensive defense of yesterday’s settlement map
- **Q frame (M3):** calculated as $P(\text{Hazard}) \times \text{Exposure} \times \text{Vulnerability}$
...
**Q2.** Option D was recommended only by M5 (E). What does this agent see that others missed - or what is it weighing differently?
