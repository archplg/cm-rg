...
- **Q frame (M1):** quantitative discipline is supposed to prevent
- **H frame (M4):** exploiting the very people it claims to serve; tokenism, disappointment, and eroded trust
- **C frame (M5):** real, but returns are solvable
