...
- **E frame (M1):** in this system? Two things: (1) health data being usable for purposes the user did not authorize, and (2) health data being accessible to parties other than the user at rest or in transit; a good trade
- **C frame (M3):** everyone is wrong? It is highly likely that a smaller model with a 60-70% capability ceiling can handle the mundane reality of consumer health coaching perfectly well
- **Q frame (M4):** and returns
