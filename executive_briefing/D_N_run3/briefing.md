...
- **neutral frame (M1):** as the 30–50 cm SLR projection drifts upward; in single points of failure, and exhausts the budget defending assets that 2–3M internal migrants will leave behind anyway
- **neutral frame (M2):** structurally rather than repeatedly rebuild after disasters; concentrating money in high-value urban areas while leaving smaller communities exposed
- **neutral frame (M3):** from the digital domain
