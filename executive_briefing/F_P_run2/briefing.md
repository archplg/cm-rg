...
- **Q frame (M1):** not TAM ceiling; it's diffuse messaging that produces low conversion against a $1200 price point; Peloton-class usage cliffs, where 40-60% of units go dormant within 12 months (cf
- **S frame (M2):** a new category
- **H frame (M4):** harm by excluding the very people they claim to serve or reduce a rich craft tradition to a consumable wellness product
