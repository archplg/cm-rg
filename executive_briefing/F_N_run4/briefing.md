...
- **neutral frame (M2):** making the device feel like an expensive wellness object whose actual use is optional
- **neutral frame (M4):** your first year far more than hoping a consumer goes deep on a wellness whim
