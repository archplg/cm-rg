...
|---|---|---|
| **Option A** | 3 of 5 | M2/neutral, M3/neutral, M5/neutral |
...
- **neutral frame (M2):** structural bias
...
**Q1.** Agents M2 (neutral), M3 (neutral), M5 (neutral) agreed on option A - but their reasoning differs (diversity=0.83). Which framing will drive execution? Different framings will produce different execution paths.

**Q2.** Option B was recommended only by M1 (neutral). What does this agent see that others missed - or what is it weighing differently?
