...
- **C frame (M1):** near-misses in years 2–3 as the trigger to escalate
- **Q frame (M2):** created: large-scale training and release of highly capable models
- **S frame (M3):** profile of frontier models shifts from cumulative, distributed harms (e
