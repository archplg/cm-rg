...
- **neutral frame (M2):** splitting focus and competing without the advantage of existing usage patterns
- **neutral frame (M4):** burning cash on customer acquisition without the parent brand’s halo
...
**Q1.** Option C was recommended only by M1 (neutral). What does this agent see that others missed - or what is it weighing differently?
