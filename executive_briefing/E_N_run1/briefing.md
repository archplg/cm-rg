...
- **neutral frame (M1):** materialize on the predicted timeline
- **neutral frame (M2):** that a small number of highly capable models can create cross-border, systemic harms before ordinary legal remedies or sectoral rules can respond; reduction was achieved
- **neutral frame (M3):** and aligns with the rhetoric of larger powers; profiles, leading to exorbitant premiums that lock out domestic startups—inverting our goal and creating the exact barrier to entry Option B was chosen to avoid
- **neutral frame (M4):** deployments through impact assessments and public consultations; before they cause damage
- **neutral frame (M5):** before they materialize
