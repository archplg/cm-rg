...
- **S frame (M2):** splitting scarce attention and creating an internal competitor before the company has defended its revenue base
- **E frame (M3):** churning to zero
- **C frame (M5):** everyone is wrong and the “disruption” narrative is mostly venture-funded theater? B2B buyers are risk-averse; they do not want core workflows rewritten by a mid-sized vendor chasing hype
