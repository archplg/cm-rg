...
[![Dataset](https://img.shields.io/badge/HuggingFace-Dataset-yellow.svg)](https://huggingface.co/datasets/sergeydolgov/cross-model-repertory-grid)
...
## Scale (Wave 4, finalized May 2026)
...
- **110,882 cross-ratings** - one of the largest M×M cross-rating LLM matrices in the published literature (closest comparable: JudgeLM-100K single-judge 100K, Judge's Verdict 2025 ~108K judge-vs-human; no published M×M LLM cross-rating dataset at our scale)
