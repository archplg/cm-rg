...
**Case:** G_N_run4 (task G, neutral framing)
...
Majority (option A) carried 5 of 5 voices.
...
- **References systemic context of the decision-making environment. &harr; E2 and E3 are anchored in protocol details and tool specificity, while E1 emphasizes the breakdown of institutional trust.**: all options scored near the middle. Worth probing whether this dimension should be weighted more strongly.
