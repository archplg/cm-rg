...
**Case:** B_P_run5 (task B, persona framing)
...
- **Existential-normative framing &harr; Systems-analytical diagnosis**: all options scored near the middle. Worth probing whether this dimension should be weighted more strongly.
- **Existential-normative framing &harr; Signal-based empirical diagnosis**: all options scored near the middle. Worth probing whether this dimension should be weighted more strongly.
