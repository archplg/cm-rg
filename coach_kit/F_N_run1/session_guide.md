...
**Case:** F_N_run1 (task F, neutral framing)
...
- **Defines identity by explicitly contrasting with casual lifestyle alternatives &harr; Defines identity purely through direct product and market attributes**: all options scored near the middle. Worth probing whether this dimension should be weighted more strongly.
