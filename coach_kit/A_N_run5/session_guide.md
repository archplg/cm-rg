...
**Case:** A_N_run5 (task A, neutral framing)
...
- **AI as product enhancement &harr; AI as workflow transformation**: all options scored near the middle. Worth probing whether this dimension should be weighted more strongly.
- **AI as product enhancement &harr; AI as workflow transformation**: all options scored near the middle. Worth probing whether this dimension should be weighted more strongly.
- **AI as workflow transformation &harr; AI as product enhancement**: all options scored near the middle. Worth probing whether this dimension should be weighted more strongly.
