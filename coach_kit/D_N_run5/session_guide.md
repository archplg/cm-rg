...
**Case:** D_N_run5 (task D, neutral framing)
...
- **Anticipates and manages population displacement from hazard zones &harr; Defends existing coastal perimeters in place using natural barriers**: all options scored near the middle. Worth probing whether this dimension should be weighted more strongly.
